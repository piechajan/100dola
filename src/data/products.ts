...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    colorFamily: "black",
    variants: [
      { sku: "scott-lumen-920-S", size: "S", color: "Carbon Black", isInStock: true, availability: "Skladem" },
      { sku: "scott-lumen-920-M", size: "M", color: "Carbon Black", isInStock: true, availability: "Skladem" },
      { sku: "scott-lumen-920-L", size: "L", color: "Carbon Black", isInStock: true, availability: "Skladem" },
      { sku: "scott-lumen-920-XL", size: "XL", color: "Carbon Black", isInStock: true, availability: "Skladem" },
    ],
  },
  {
    id: 36,
    ...
    colorFamily: "grey",
    variants: [
      { sku: "scott-lumen-eride-900-M", size: "M", color: "Grey / Green", isInStock: true, availability: "Skladem" },
      { sku: "scott-lumen-eride-900-L", size: "L", color: "Grey / Green", isInStock: true, availability: "Skladem" },
      { sku: "scott-lumen-eride-900-XL", size: "XL", color: "Grey / Green", isInStock: true, availability: "Skladem" },
    ],
  },
  {
    id: 14,
