...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 41,
    name: "Bulls Sonic SX 1",
    slug: "bulls-sonic-sx-1-2026",
    year: "2026",
    brand: "bulls",
    categoryId: "elektro",
    priceWithVat: 58749,
    originalPriceWithVat: 124999,
    vatRate: 21,
    bulky: true,
    badges: ["Elektro", "Sleva"],
    note: "Lehké karbonové horské elektrokolo Bulls Sonic SX 1 s tichým motorem Bosch Performance Line SX (55 Nm) a baterií 400 Wh. Přirozený pocit z jízdy, vzduchová vidlice SR Suntour 120 mm a spolehlivý Shimano Deore 12s. Původní cena 124 999 Kč — teď se slevou 53 %.",
    photo: "/media/bulls-sonic-sx-1.webp",
    specs: ["Bosch Performance Line SX · 55 Nm · 400 Wh", "Shimano Deore 12 rychlostí · hydraulické kotouče", "Karbon · vidlice 120 mm · 29\""],
    ebikeBatteryWh: 400,
    gender: "U",
    useCase: "performance",
    color: "UD Carbon",
    colorFamily: "black",
    specTable: [
      { label: "Motor", value: "Bosch Performance Line SX (Smart System) · 55 Nm · podpora do 25 km/h" },
      { label: "Baterie", value: "Bosch CompactTube 400 · 400 Wh" },
      { label: "Nabíječka", value: "Bosch Compact charger 2A" },
      { label: "Displej", value: "Bosch Mini Remote + System Controller" },
      { label: "Materiál rámu", value: "Karbon" },
      { label: "Vidlice", value: "SR Suntour Raidon 34 Air · zdvih 120 mm" },
      { label: "Hlavové složení", value: "Acros AIF-531 1.5" },
      { label: "Přehazovačka", value: "Shimano Deore RD-M6100 · 12 rychlostí" },
      { label: "Řazení", value: "Shimano Deore SL-M6100 rapidfire+" },
      { label: "Kliky", value: "Samox EC40" },
      { label: "Kazeta", value: "Shimano Deore CS-M6100-12 · 10-51T" },
      { label: "Řetěz", value: "Shimano Deore CN-M6100-12" },
      { label: "Brzdy", value: "Shimano BR-MT420 hydraulické · kotouče 203/180 mm" },
      { label: "Kola", value: "Shimano WH-MT620 · 29\" · tubeless ready" },
      { label: "Pláště", value: "Schwalbe Nobby Nic Perf · 29×2,40" },
      { label: "Řídítka / představec", value: "Rumble Altimate" },
      { label: "Sedlo", value: "Selle Royal SRX" },
      { label: "Sedlovka", value: "Limotec Alpha Serie" },
    ],
    variants: [
      { size: "S", isInStock: false, availability: "Na objednávku" },
      { size: "M", isInStock: false, availability: "Na objednávku" },
  ...
  {
    id: 42,
    name: "Bulls Sonic AM-SX 2",
    slug: "bulls-sonic-am-sx-2-2026",
    year: "2026",
    brand: "bulls",
    categoryId: "elektro",
    priceWithVat: 86949,
    originalPriceWithVat: 184999,
    vatRate: 21,
    bulky: true,
    badges: ["Elektro", "Sleva"],
    note: "Celoodpružené karbonové horské elektrokolo Bulls Sonic AM-SX 2 pro all-mountain — motor Bosch Performance Line SX (55 Nm), baterie 400 Wh, odpružení RockShox Pike 140 mm / Deluxe Select+ 130 mm a bezdrátové SRAM GX Eagle AXS Transmission. Jen 17,5 kg. Původní cena 184 999 Kč — teď se slevou 53 %.",
    photo: "/media/bulls-sonic-am-sx-2.webp",
    specs: ["Bosch Performance Line SX · 55 Nm · 400 Wh", "SRAM GX Eagle AXS Transmission · bezdrát", "Celoodpružené 140/130 mm · karbon · 17,5 kg"],
    ebikeBatteryWh: 400,
    gender: "U",
    useCase: "performance",
    color: "Carbon",
    ...
    specTable: [
      ...
      { label: "Displej", value: "Bosch Mini Remote + System Controller" },
      { label: "Materiál rámu", value: "Karbon" },
      { label: "Vidlice", value: "RockShox Pike · zdvih 140 mm" },
      { label: "Zadní tlumič", value: "RockShox Deluxe Select+ RL · zdvih 130 mm" },
      { label: "Hlavové složení", value: "Acros AIF-531 1.5" },
      { label: "Přehazovačka", value: "SRAM GX Eagle AXS Transmission · bezdrátové" },
      { label: "Řazení", value: "SRAM AXS Rocker" },
      { label: "Kliky", value: "SRAM GX Eagle" },
      { label: "Kazeta", value: "SRAM GX Eagle T-Type · 10-52T" },
      { label: "Řetěz", value: "SRAM Eagle GX" },
      { label: "Brzdy", value: "TRP C2.3RX Trail · kotouče 203/203 mm" },
      { label: "Kola", value: "Mavic E-Crosstrail SL · 29\"" },
      { label: "Pláště", value: "Schwalbe Nobby Nic Perf · 29×2,40" },
      { label: "Řídítka / představec", value: "Rumble Altimate" },
      { label: "Sedlo", value: "Prologo Proxim 400 wide" },
      { label: "Sedlovka", value: "Limotec Alpha Series A1-UH · zdvih 125 mm" },
      { label: "Hmotnost", value: "17,5 kg (15,7 kg bez baterie)" },
    ],
    variants: [
      { size: "S", isInStock: false, availability: "Na objednávku" },
      { size: "M", isInStock: false, availability: "Na objednávku" },
  ...
  {
    id: 43,
    name: "Bulls Sonic AM-SX I",
    slug: "bulls-sonic-am-sx-i-2026",
    year: "2026",
    brand: "bulls",
    categoryId: "elektro",
    priceWithVat: 117499,
    originalPriceWithVat: 249999,
    vatRate: 21,
    bulky: true,
    badges: ["Elektro", "Sleva"],
    note: "Vlajkové celoodpružené karbonové horské elektrokolo Bulls Sonic AM-SX I — motor Bosch Performance Line SX (55 Nm), baterie 400 Wh, špičkové RockShox Pike Ultimate 140 mm / Deluxe Ultimate 130 mm, bezdrátové SRAM XX Eagle Transmission AXS a karbonová kola Mavic. Jen 17 kg. Původní cena 249 999 Kč — teď se slevou 53 %.",
    photo: "/media/bulls-sonic-am-sx-i.webp",
    specs: ["Bosch Performance Line SX · 55 Nm · 400 Wh", "SRAM XX Eagle Transmission AXS · bezdrát", "Karbon + karbon kola · 140/130 mm · 17 kg"],
    ebikeBatteryWh: 400,
    gender: "U",
    useCase: "performance",
    color: "Carbon",
    ...
    specTable: [
      ...
      { label: "Displej", value: "Bosch Mini Remote + System Controller" },
      { label: "Materiál rámu", value: "Karbon" },
      { label: "Vidlice", value: "RockShox Pike Ultimate · zdvih 140 mm" },
      { label: "Zadní tlumič", value: "RockShox Deluxe Ultimate RCT · zdvih 130 mm" },
      { label: "Přehazovačka", value: "SRAM XX Eagle Transmission AXS · bezdrátové" },
      { label: "Řazení", value: "SRAM AXS Rocker" },
      { label: "Kliky", value: "SRAM XX Eagle" },
      { label: "Kazeta", value: "SRAM XX Eagle Transmission · 10-52T" },
      { label: "Brzdy", value: "TRP C2.3RX Trail · kotouče 203/203 mm" },
      { label: "Kola", value: "Mavic E-Crosstrail SL Carbon · 29\"" },
      { label: "Pláště", value: "Schwalbe Nobby Nic EVO · 29×2,35" },
      { label: "Řídítka", value: "Bulls Enduro Carbon 35 mm" },
      { label: "Gripy", value: "Ergon GD10 Evo" },
      { label: "Sedlo", value: "Prologo Proxim W850" },
      { label: "Sedlovka", value: "Limotec Alpha Series A1-UH · zdvih 125 mm" },
      { label: "Hmotnost", value: "17 kg (15 kg bez baterie)" },
    ],
    variants: [
      { size: "S", isInStock: false, availability: "Na objednávku" },
      { size: "M", isInStock: false, availability: "Na objednávku" },
  ...
  {
    id: 44,
    name: "Bulls Sonic AM-SX 1",
    slug: "bulls-sonic-am-sx-1-2026",
    year: "2026",
    brand: "bulls",
    categoryId: "elektro",
    priceWithVat: 70499,
    originalPriceWithVat: 149999,
    vatRate: 21,
    bulky: true,
    badges: ["Elektro", "Sleva"],
    note: "Celoodpružené karbonové horské elektrokolo Bulls Sonic AM-SX 1 pro all-mountain — motor Bosch Performance Line SX (55 Nm), baterie 400 Wh, odpružení BULLS Lytro 140 mm / SR Suntour Edge Plus 130 mm a spolehlivý Shimano Deore 12s. 17,9 kg. Původní cena 149 999 Kč — teď se slevou 53 %.",
    photo: "/media/bulls-sonic-am-sx-1.webp",
    specs: ["Bosch Performance Line SX · 55 Nm · 400 Wh", "Shimano Deore 12 rychlostí · hydraulické kotouče", "Celoodpružené 140/130 mm · karbon · 17,9 kg"],
    ebikeBatteryWh: 400,
    gender: "U",
    useCase: "performance",
    ...
    specTable: [
      ...
      { label: "Displej", value: "Bosch Mini Remote + System Controller" },
      { label: "Materiál rámu", value: "Karbon" },
      { label: "Vidlice", value: "BULLS Lytro 34 SL · zdvih 140 mm" },
      { label: "Zadní tlumič", value: "SR Suntour Edge Plus 2CR · zdvih 130 mm" },
      { label: "Hlavové složení", value: "Acros AIF-531 1.5" },
      { label: "Přehazovačka", value: "Shimano Deore RD-M6100 · 12 rychlostí" },
      { label: "Řazení", value: "Shimano Deore" },
      { label: "Kliky", value: "Samox EC40" },
      { label: "Kazeta", value: "Shimano Deore CS-M6100-12 · 10-51T" },
      { label: "Řetěz", value: "Shimano Deore CN-M6100-12" },
      { label: "Brzdy", value: "Shimano BR-MT420 hydraulické · kotouče 203/203 mm" },
      { label: "Kola", value: "Shimano WH-MT620 · 29\" · tubeless ready" },
      { label: "Pláště", value: "Schwalbe Nobby Nic Perf · 29×2,40" },
      { label: "Řídítka / představec", value: "Rumble Altimate" },
      { label: "Sedlo", value: "Selle Royal SRX" },
      { label: "Sedlovka", value: "Limotec Alpha Series A1-UH · zdvih 125 mm" },
      { label: "Hmotnost", value: "17,9 kg (16,4 kg bez baterie)" },
    ],
    variants: [
      { size: "S", isInStock: false, availability: "Na objednávku" },
      { size: "M", isInStock: false, availability: "Na objednávku" },
