...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    colorFamily: "white",
    variants: [
      { sku: "scott-lumen-905-2025-M", size: "M", color: "Cumulus White / Carbon Black", isInStock: true, availability: "Skladem" },
      { sku: "scott-lumen-905-2025-L", size: "L", color: "Cumulus White / Carbon Black", isInStock: true, availability: "Skladem" },
      { sku: "scott-lumen-905-2025-XL", size: "XL", color: "Cumulus White / Carbon Black", isInStock: true, availability: "Skladem" },
    ],
  },
  {
    id: 35,
    name: "Scott Lumen 920",
    slug: "scott-lumen-920-2025",
    year: "2025",
    brand: "scott",
    categoryId: "elektro",
    priceWithVat: 168990,
    ...
    colorFamily: "black",
    variants: [
      { sku: "scott-lumen-920-2025-S", size: "S", color: "Carbon Black", isInStock: true, availability: "Skladem" },
      { sku: "scott-lumen-920-2025-M", size: "M", color: "Carbon Black", isInStock: true, availability: "Skladem" },
      { sku: "scott-lumen-920-2025-L", size: "L", color: "Carbon Black", isInStock: true, availability: "Skladem" },
      { sku: "scott-lumen-920-2025-XL", size: "XL", color: "Carbon Black", isInStock: true, availability: "Skladem" },
    ],
  },
  {
    id: 36,
    name: "Scott Lumen eRIDE 900",
    slug: "scott-lumen-eride-900-2025",
    year: "2025",
    brand: "scott",
    categoryId: "elektro",
    priceWithVat: 178493,
    ...
    colorFamily: "grey",
    variants: [
      { sku: "scott-lumen-eride-900-2025-M", size: "M", color: "Grey / Green", isInStock: true, availability: "Skladem" },
      { sku: "scott-lumen-eride-900-2025-L", size: "L", color: "Grey / Green", isInStock: true, availability: "Skladem" },
      { sku: "scott-lumen-eride-900-2025-XL", size: "XL", color: "Grey / Green", isInStock: true, availability: "Skladem" },
    ],
  },
  {
    id: 14,
