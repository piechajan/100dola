...
export const PRODUCTS: Product[] = [
  ...
  {
    id: 38,
    name: "Scott Contessa Genius ST 910",
    slug: "scott-contessa-genius-st-910",
    year: null,
    brand: "scott",
    categoryId: "mtb-celoodpruzena",
    priceWithVat: 109194,
    originalPriceWithVat: 181990,
    vatRate: 21,
    bulky: true,
    badges: ["Skladem", "Sleva"],
    note: "Dámské (totožné s pánským, liší se pouze barvou) celoodpružené horské kolo Scott Contessa Genius ST 910 — lehký karbon, jen 14,8 kg, tlumič FOX Float X Nude s TracLoc, bezdrátové SRAM GX Eagle AXS a brzdy Shimano XT. Skladem velikost S.",
    photo: "/media/scott-contessa-genius-st-910.webp",
    specs: ["SRAM GX Eagle AXS Transmission 12s · Shimano XT M8120 4-pístky", "Odpružení FOX Float X Nude · TracLoc Technology", "Karbon · 14,8 kg · 29\""],
    gender: "F",
    useCase: "performance",
    color: "Black / Iridescent",
    colorFamily: "black",
    variants: [
      { sku: "scott-contessa-genius-st-910-S", size: "S", color: "Black / Iridescent", isInStock: true, availability: "Skladem" },
    ],
  },
  {
    id: 39,
    name: "Scott Genius ST 910",
    slug: "scott-genius-st-910",
    year: null,
    brand: "scott",
    categoryId: "mtb-celoodpruzena",
    priceWithVat: 99995,
    originalPriceWithVat: 199990,
    vatRate: 21,
    bulky: true,
    badges: ["Sleva"],
    note: "Celoodpružené karbonové horské kolo Scott Genius ST 910 — jen 14,4 kg, tlumič FOX Float X Nude s TracLoc, bezdrátové SRAM GX Eagle AXS a brzdy Shimano XT. (Totožné s dámskou Contessa verzí, liší se pouze barvou.)",
    photo: "/media/scott-genius-st-910.webp",
    specs: ["SRAM GX Eagle AXS Transmission 12s · Shimano XT M8120 4-pístky", "Odpružení FOX Float X Nude · TracLoc Technology", "Karbon · 14,4 kg · 29\""],
    gender: "M",
    useCase: "performance",
    color: "Teal Green",
    colorFamily: "green",
    variants: [
      { sku: "scott-genius-st-910-S", size: "S", color: "Teal Green", isInStock: false, availability: "Na objednávku" },
      { sku: "scott-genius-st-910-M", size: "M", color: "Teal Green", isInStock: false, availability: "Na objednávku" },
      { sku: "scott-genius-st-910-L", size: "L", color: "Teal Green", isInStock: false, availability: "Na objednávku" },
      { sku: "scott-genius-st-910-XL", size: "XL", color: "Teal Green", isInStock: false, availability: "Na objednávku" },
    ],
  },
  {
    id: 40,
    name: "Q36.5 Salopette Essential",
    slug: "q365-salopette-essential",
    year: null,
    brand: "q36.5",
    categoryId: "obleceni-kalhoty",
    priceWithVat: 3640,
    vatRate: 21,
    bulky: false,
    badges: [],
    note: "Pánské laclové (bib) šortky Q36.5 Salopette Essential — Super Moulded vložka pro komfort na každém kilometru, minimum švů proti otlakům a 100% recyklovaná příze. Univerzální letní šortky na jízdy všech délek.",
    photo: "/media/q365-salopette-essential.webp",
    gallery: [
    ...
    gender: "M",
    season: "leto",
    garmentLength: "kratke",
    color: "Black",
    colorFamily: "black",
    variants: [
      { sku: "q365-salopette-essential-XS", size: "XS", color: "Black", isInStock: true, availability: "Skladem" },
      { sku: "q365-salopette-essential-S", size: "S", color: "Black", isInStock: true, availability: "Skladem" },
      { sku: "q365-salopette-essential-M", size: "M", color: "Black", isInStock: true, availability: "Skladem" },
      { sku: "q365-salopette-essential-L", size: "L", color: "Black", isInStock: true, availability: "Skladem" },
      { sku: "q365-salopette-essential-XL", size: "XL", color: "Black", isInStock: true, availability: "Skladem" },
      { sku: "q365-salopette-essential-XXL", size: "XXL", color: "Black", isInStock: true, availability: "Skladem" },
      { sku: "q365-salopette-essential-XXXL", size: "XXXL", color: "Black", isInStock: true, availability: "Skladem" },
    ],
  },
  {
    id: 14,
  ...
  },
  {
    ...
    vatRate: 21,
    bulky: true,
    badges: ["Gravel", "GRX 2×22", "Sleva"],
    note: "Univerzální gravel stroj s karbonovým rámem HMF — pohltí nerovnosti a drží komfort na celý den bez ztráty tuhosti do šlapek. Spolehlivé 2× řazení Shimano GRX RX810/600, hydraulické kotouče, pláště Schwalbe G-One Bite až 45 mm.",
    ...
    specs: ["Shimano GRX RX810/600 · 2×22", "Praxis Alba 48/32 · Schwalbe G-One Bite 45c", "HMF karbon · 9,44 kg"],
    gender: "U",
    useCase: "performance",
    color: "Carbon Grey",
    colorFamily: "grey",
