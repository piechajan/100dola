...
→ [Stáhnout GPX](/routes/kohutka-valmez.gpx)`,
  ...
  },
  {
    ...
    locationDetail: "Trail centrum Semetín, Vsetín",
    distance: "40 km",
    elevation: "~1 100 m",
    difficulty: "Střední",
    capacity: 18,
    ...
    longDescription: `Singletracky v Semetínském údolí — jeden z nejlepších trail center na Valašsku. Flow traily i technické sekce, na kolech i na nohou hezký den v lese.

Sraz odpoledne, jedeme dokud je světlo, a po jízdě zajdeme na kafe. Tempo pohodové, nikdo nezůstane vzadu.`,
    whatToBring: [
      "MTB (trailové / enduro)",
      "Helma — povinná, ideálně i chrániče",
      "Voda a menší svačina",
      "Přední/zadní světlo (jedeme do večera)",
    ],
    whoIsItFor: "Pro MTB jezdce se základní technikou. Singletracky se dají jet klidně i svižně — tempo si každý najde.",
    organizer: { name: "Jan Piecha", role: "Zakladatel Open Miles Clinic" },
...
Na trase plánujeme oběd v horské boudě a kávovou zastávku na Pustevnách.`,
  ...
  },
  {
    ...
    distance: "~80–120 km / den",
    elevation: "~1 000–2 000 m / den",
    difficulty: "Střední",
    capacity: 12,
    filled: 4,
...
O logistiku kolem kola se staráme my — dopravu kola, servis a podporu na místě. S letenkou a ubytováním ti poradíme a doporučíme prověřené možnosti, ale pořizuješ si je sám (nejsou součástí ceny našich služeb). Ty se soustředíš na ježdění. Rozpočet a detaily našich služeb pošleme na vyžádání přes přihlášku níže.`,
    included: [
      ...
      "**Transfer ze základny → letiště** (kam poslední den dojedeme).",
    ...
    whatToBring: [
      ...
      "**Blikačky / světla** — některé úseky vedou přes tunely (a když se zdržíme v baru, dojedeme klidně i za tmy)",
