...
export const SOCIAL_RIDES: SocialRide[] = [
  {
    ...
    story: [
      ...
      "Za 100dola sport stojí kamenná prodejna ve Šternberku a e-shop — a cyklistiku sami žijeme a jezdíme. Stejnou péči dáváme do výběru kol a vybavení, které prodáváme: silniční, gravel a horská kola SCOTT, ISAAC, Lapierre, Ridley a Pinarello, cyklistické oblečení Q36.5, helmy, tretry, radary a osvětlení — a k tomu běžecké boty a oblečení. Přijeď se s námi projet, poznej styl a přístup, jaký k cyklistice máme — a když budeš řešit nové kolo, budeš vědět, komu věřit.",
    ],
    faq: [
      {
  ...
  },
  {
    ...
    story: [
      ...
      "Za 100dola sport stojí kamenná prodejna ve Šternberku a e-shop — a cyklistiku sami žijeme a jezdíme. Prodáváme silniční, gravel a horská kola SCOTT, ISAAC, Lapierre, Ridley a Pinarello, cyklistické oblečení Q36.5, helmy, tretry, radary a osvětlení — a k tomu běžecké boty a oblečení. Kamennou prodejnu na Vsetíně zatím nemáme, ale kolo i vybavení k tobě po domluvě dovezeme nebo předáme osobně. Nejdřív se přijeď projet a poznej, jaký přístup k cyklistice máme — o kole se pobavíme, až budeš chtít.",
    ],
    faq: [
      {
  ...
  },
  {
    ...
    story: [
      ...
      "Za 100dola sport stojí kamenná prodejna ve Šternberku a e-shop — a cyklistiku sami žijeme a jezdíme. Prodáváme silniční, gravel a horská kola SCOTT, ISAAC, Lapierre, Ridley a Pinarello, cyklistické oblečení Q36.5, helmy, tretry, radary a osvětlení — a k tomu běžecké boty a oblečení. Kamennou prodejnu na Novojičínsku zatím nemáme, ale kolo i vybavení k tobě po domluvě dovezeme nebo předáme osobně. Přijeď se s námi nejdřív projet — poznáš přístup, jaký k cyklistice máme, a o kole se pobavíme, až budeš chtít.",
    ],
    faq: [
      {
