    ...
    <article id="zavod-miru-sternberk" className="bg-white">
      <div className="max-w-[820px] mx-auto px-6 md:px-12 py-12 md:py-16">
        ...
        <p className="text-[10px] text-[#9AA3C2] mb-10">
          Hero foto: peloton, ilustrační —{" "}
          <a
            href="https://unsplash.com/photos/0c623066013b"
            target="_blank"
        ...
        <div className="bg-gradient-to-br from-[#1a1a2e] to-[#2a2a4e] text-white rounded-2xl p-6 md:p-8 mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 text-white text-sm font-bold transition"
            >
